...
public class PostController {
    ...
    @Operation(summary = "Get Only Users Post  Rest API",
    ...
    @Operation(summary = "Get Posts By Category Rest API",
    ...
    @Operation(summary = "Search Post Rest API",
            description = "Search Post REST API is used to fetch posts by query")
    @ApiResponse(responseCode = "200", description = "Http Status 200 SUCCESS")
    @GetMapping("/posts/search/{query}")
    public ResponseEntity<List<PostResponse>> searchPost(@PathVariable("query") String query) {
        return new ResponseEntity<>(postService.searchPosts(query), OK);
    }
    ...
    @Operation(summary = "Upload Image To Post Rest API",
            description = "Upload Image REST API is used to upload image to post")
    @ApiResponse(responseCode = "200", description = "Http Status 200 SUCCESS")
    ...
    @Operation(summary = "View Post Image Rest API",
            description = "View Post Image REST API is used to view post image")
    @ApiResponse(responseCode = "200", description = "Http Status 200 SUCCESS")
...
//    }
    ...
    @Operation(summary = "Delete One Image Rest API",
            description = "Delete One Image REST API is used to delete only one image in post")
    @ApiResponse(responseCode = "200", description = "Http Status 200 SUCCESS")
    ...
    @Operation(summary = "Delete All Images Rest API",
            description = "Delete All Images REST API is used to delete all images in post")
    @ApiResponse(responseCode = "200", description = "Http Status 200 SUCCESS")
